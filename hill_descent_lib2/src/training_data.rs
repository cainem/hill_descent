...
///
/// ```rust,ignore
/// use hill_descent_lib2::{setup_world, GlobalConstants, SingleValuedFunction, TrainingData};
///
/// #[derive(Debug)]
/// struct Sphere;
///
...
///
/// ```rust,ignore
/// use hill_descent_lib2::{setup_world, GlobalConstants, WorldFunction, TrainingData};
///
/// # #[derive(Debug)]
