...
mod tests {
    ...
    fn given_multiple_dimensions_when_double_called_then_round_robin_division_occurs() {
        ...
        assert_eq!(
            dims.dimensions[0].number_of_divisions(),
            2,
            "Dim 0 after 2nd double"
        );
        assert_eq!(
            dims.dimensions[1].number_of_divisions(),
            2,
            "Dim 1 after 2nd double"
        );
        assert_eq!(
            dims.dimensions[2].number_of_divisions(),
            1,
            "Dim 2 after 2nd double"
        );
        ...
        assert_eq!(
            dims.dimensions[0].number_of_divisions(),
            2,
            "Dim 0 after 3rd double"
        );
        assert_eq!(
            dims.dimensions[1].number_of_divisions(),
            2,
            "Dim 1 after 3rd double"
        );
        assert_eq!(
            dims.dimensions[2].number_of_divisions(),
            2,
            "Dim 2 after 3rd double"
        );
        ...
        assert_eq!(
            dims.dimensions[0].number_of_divisions(),
            3,
            "Dim 0 after 4th double"
        );
        assert_eq!(
            dims.dimensions[1].number_of_divisions(),
            2,
            "Dim 1 after 4th double"
        );
        assert_eq!(
            dims.dimensions[2].number_of_divisions(),
            2,
            "Dim 2 after 4th double"
        );
