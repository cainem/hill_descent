...
/// Benchmarks a training epoch of the hill-descent-lib3 algorithm when optimising a
/// 100-dimensional function. The benchmark mirrors the structure of lib2's benchmark
/// to allow direct comparison.
fn hill_descent_lib3_100d_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("hill_descent_lib3_train_epoch_100d", |b| {
        b.iter(|| {
...
criterion_group!(benches, hill_descent_lib3_100d_benchmark);
