//! Finding the most diverse dimension index.
//!
//! This module provides functions to identify which dimension has the most
//! diversity based on unique value count and standard deviation.
...
mod tests {
    ...
    #[test]
    fn given_single_dimension_with_diversity_when_find_most_diverse_index_then_returns_zero() {
        let stats = vec![(3, 5.0)];
        assert_eq!(find_most_diverse_index(stats), Some(0));
    }
}
