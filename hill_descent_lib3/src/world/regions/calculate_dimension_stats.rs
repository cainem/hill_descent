//! Dimension statistics calculation for diversity analysis.
//!
//! This module provides functions to calculate statistics (unique count and
//! standard deviation) for each dimension of the phenotype values.

use super::count_unique_values_with_tolerance::count_unique_values_with_tolerance;
...
mod tests {
    ...
    #[test]
    fn given_empty_values_when_calculate_dimension_stats_then_returns_empty() {
    ...
    #[test]
    fn given_single_value_when_calculate_dimension_stats_then_returns_one_unique_zero_std_dev() {
