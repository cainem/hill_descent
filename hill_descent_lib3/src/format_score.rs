...
///
/// ```
/// use hill_descent_lib3::format_score::format_score;
///
/// let score = f64::MAX;
...
/// # See Also
///
/// - [`World::get_best_score`](crate::World::get_best_score) - Get the raw score value
/// - [`World::training_run`](crate::World::training_run) - Run optimization to score organisms
