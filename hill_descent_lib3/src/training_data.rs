...
///
/// ```rust,ignore
/// use hill_descent_lib3::{setup_world, GlobalConstants, SingleValuedFunction, TrainingData};
///
/// #[derive(Debug)]
/// struct Sphere;
///
...
///
/// ```rust,ignore
/// use hill_descent_lib3::{setup_world, GlobalConstants, WorldFunction, TrainingData};
///
/// # #[derive(Debug)]
...
pub enum TrainingData<'a> {
    ...
    ///
    /// ```rust
    /// use hill_descent_lib3::TrainingData;
    ///
